...
class RedisManager:
    ...
    async def close(self) -> None:
        ...
        if self.connection_pool:
            ...
            self.logger.info("redis_connection_pool_closed", message="Redis connection pool closed successfully")
...
class SessionStore:
    ...
    async def store_progress(self, session_id: str, progress_data: Dict[str, Any]) -> None:

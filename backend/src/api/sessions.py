...
from ..services.session_service import (
    SessionService, get_session_service, SessionNotFoundError, InvalidSessionStateError
)
...
@router.get("/{session_id}", response_model=SessionDetailResponse, response_model_exclude_none=True)
...
async def advance_to_next_step(
    ...
    try:
        ...
        return {
            ...
            "message": "Advanced to next step" if has_next_step else "Session completed"
        }
